...
Ext.calendar.EventEditForm = Ext.extend(Ext.form.FormPanel, {
    ...
    initComponent: function() {
		...
		this.eventsField = new Ext.form.ComboBox({
            xtype: 'combo',
			name: 'event_id',
			hiddenName: 'data[AcademicCalendarEvent][event_id]',
			fieldLabel: 'Event',
			typeAhead: true,
        ...
        var leftFields = [this.eventsField, this.titleField, this.dateRangeField, this.reminderField],
