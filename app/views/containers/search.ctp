...
var containerSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var containerSearchWindow = new Ext.Window({
	title: '<?php __('Search Module'); ?>',
	modal: true,
	items: containerSearchForm,
	resizable: false,
	width: 550,
	height: 400,
