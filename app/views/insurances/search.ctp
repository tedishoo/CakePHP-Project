...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['CollateralDetail.name', '<?php __('CollateralDetail'); ?>']
,			['Insurance.estimated_value', '<?php __('Estimated Value'); ?>']
,			['Insurance.date_estimated', '<?php __('Date Estimated'); ?>']
,			['Insurance.insurance_company', '<?php __('Insurance Company'); ?>']
,			['Insurance.type', '<?php __('Type'); ?>']
,			['Insurance.date_insured', '<?php __('Date Insured'); ?>']
,			['Insurance.amount_insured', '<?php __('Amount Insured'); ?>']
,			['Insurance.expire_date', '<?php __('Expire Date'); ?>']
,			['Insurance.policy_number', '<?php __('Policy Number'); ?>']
,			['Insurance.created', '<?php __('Created'); ?>']
,			['Insurance.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var insuranceSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var insuranceSearchWindow = new Ext.Window({
	title: '<?php __('Search Insurance'); ?>',
	modal: true,
	items: insuranceSearchForm,
	resizable: false,
	width: 550,
	height: 400,
