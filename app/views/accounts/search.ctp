...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Account.first_name', '<?php __('First Name'); ?>']
,			['Account.middle_name', '<?php __('Middle Name'); ?>']
,			['Account.last_name', '<?php __('Last Name'); ?>']
,			['Account.account_ref_no', '<?php __('Account Ref No'); ?>']
,			['Account.date_account_opened', '<?php __('Date Account Opened'); ?>']
,			['Account.opening_balance_indicator', '<?php __('Opening Balance Indicator'); ?>']
,			['Account.credit_type_code', '<?php __('Credit Type Code'); ?>']
,			['Account.product_type_code', '<?php __('Product Type Code'); ?>']
,			['Account.admin_fee', '<?php __('Admin Fee'); ?>']
,			['Account.restructured_credit_account_ref_no', '<?php __('Restructured Credit Account Ref No'); ?>']
,			['Account.industry_sector_code', '<?php __('Industry Sector Code'); ?>']
,			['Account.industry_sub_sector', '<?php __('Industry Sub Sector'); ?>']
,			['Account.export_credit_guarante', '<?php __('Export Credit Guarante'); ?>']
,			['Account.created', '<?php __('Created'); ?>']
,			['Account.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var accountSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var accountSearchWindow = new Ext.Window({
	title: '<?php __('Search Account'); ?>',
	modal: true,
