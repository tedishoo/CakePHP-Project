...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Collateral.name', '<?php __('Collateral'); ?>']
,			['CollateralDetail.type', '<?php __('Type'); ?>']
,			['CollateralDetail.Owner', '<?php __('Owner'); ?>']
,			['CollateralDetail.titledeed_or_platenumber', '<?php __('Titledeed Or Platenumber'); ?>']
,			['CollateralDetail.city', '<?php __('City'); ?>']
,			['CollateralDetail.wereda_or_chasisnumber', '<?php __('Wereda Or Chasisnumber'); ?>']
,			['CollateralDetail.kebele_or_motornumber', '<?php __('Kebele Or Motornumber'); ?>']
,			['CollateralDetail.housenumber_or_yearofmake', '<?php __('Housenumber Or Yearofmake'); ?>']
,			['CollateralDetail.created', '<?php __('Created'); ?>']
,			['CollateralDetail.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var collateralDetailSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
		...
		
		{
			...
			handler: function(){
				if(ParamStore.getCount() == 0)
					...
					collateralDetailSearchWindow.close();
...
var collateralDetailSearchWindow = new Ext.Window({
	title: '<?php __('Search CollateralDetail'); ?>',
	modal: true,
	items: collateralDetailSearchForm,
	resizable: false,
	width: 550,
	height: 400,
