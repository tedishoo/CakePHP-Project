...
var store_branch_credits = new Ext.data.Store({
	...
	proxy: new Ext.data.HttpProxy({
		url: '<?php echo $this->Html->url(array('controller' => 'credits', 'action' => 'list_data', $branch['Branch']['id'])); ?>'	})
});
		
<?php $branch_html = "<table cellspacing=3>" . 		"<tr><th align=right>" . __('Name', true) . ":</th><td><b>" . $branch['Branch']['name'] . "</b></td></tr>" . 
		"<tr><th align=right>" . __('Nbe Code', true) . ":</th><td><b>" . $branch['Branch']['nbe_code'] . "</b></td></tr>" . 
		"<tr><th align=right>" . __('Flex Code', true) . ":</th><td><b>" . $branch['Branch']['flex_code'] . "</b></td></tr>" . 
		"<tr><th align=right>" . __('Created', true) . ":</th><td><b>" . $branch['Branch']['created'] . "</b></td></tr>" . 
		"<tr><th align=right>" . __('Modified', true) . ":</th><td><b>" . $branch['Branch']['modified'] . "</b></td></tr>" . 
"</table>"; 
?>
		...
		var branch_view_panel_2 = new Ext.TabPanel({
			...
			items:[
			{
				...
				loadMask: true,
				stripeRows: true,
				store: store_branch_credits,
				title: '<?php __('Credits'); ?>',
				enableColumnMove: false,
				listeners: {
					activate: function(){
						if(store_branch_credits.getCount() == '')
							store_branch_credits.reload();
					}
				},
				columns: [
