...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Adjustment.mobile', '<?php __('Mobile'); ?>']
,			['Adjustment.date', '<?php __('Date'); ?>']
,			['Adjustment.created', '<?php __('Created'); ?>']
,			['Adjustment.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var adjustmentSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var adjustmentSearchWindow = new Ext.Window({
	title: '<?php __('Search Adjustment'); ?>',
	modal: true,
	items: adjustmentSearchForm,
	resizable: false,
	width: 550,
	height: 400,
