...
,			['Collateral.created', '<?php __('Created'); ?>']
,			['Collateral.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var collateralSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var collateralSearchWindow = new Ext.Window({
	title: '<?php __('Search Collateral'); ?>',
	modal: true,
	items: collateralSearchForm,
	resizable: false,
	width: 550,
	height: 400,
