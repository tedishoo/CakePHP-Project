...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Batch.month', '<?php __('Month'); ?>']
,			['Batch.year', '<?php __('Year'); ?>']
,			['Batch.created', '<?php __('Created'); ?>']
,			['Batch.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var batchSearchForm = new Ext.form.FormPanel({
	baseCls: 'x-plain',
	labelWidth: 55,
...
var batchSearchWindow = new Ext.Window({
	title: '<?php __('Search Batch'); ?>',
	modal: true,
	items: batchSearchForm,
	resizable: false,
	width: 550,
	height: 400,
