...
var SearchField = new Ext.form.ComboBox({
	...
	store: new Ext.data.ArrayStore({
		...
		data: [
			['Date.date', '<?php __('Date'); ?>']
,			['Date.created', '<?php __('Created'); ?>']
,			['Date.modified', '<?php __('Modified'); ?>']
		]
	}),
	mode: 'local',
...
var dateSearchWindow = new Ext.Window({
	title: '<?php __('Search Date'); ?>',
	modal: true,
	items: dateSearchForm,
	resizable: false,
	width: 550,
	height: 400,
