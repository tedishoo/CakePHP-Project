...
class PdfMerger
{
	...
	{
		require_once(LIBS . 'fpdf' . DS . 'fpdf.php');
		require_once(LIBS . 'fpdi' . DS . 'fpdi.php');
	}
	...
	public function merge($outputmode = 'browser', $outputpath = 'newfile.pdf')
	{
		...
		else
		{
			...
			{
				throw new exception("Error outputting PDF to '$outputmode' with output path: '$outputpath'");
				return false;
			}
		}
